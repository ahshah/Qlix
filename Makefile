...
# Generated by qmake (2.01a) (Qt 4.2.3) on: Sun Aug 12 02:48:24 2007
# Project:  Qlix.pro
# Template: app
...
CXXFLAGS      = -pipe -g -I/usr/local/include/taglib -L/usr/local/lib -ltag -g -Wall -W -D_REENTRANT  $(DEFINES)
LEXFLAGS      = 
YACCFLAGS     = -d
