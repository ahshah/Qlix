...
# Generated by qmake (2.01a) (Qt 4.3.2) on: Sat Mar 1 12:10:31 2008
# Project:  Qlix.pro
# Template: app
...
CXXFLAGS      = -pipe -I/usr/include/taglib -L/usr/lib -ltag -g -Wall -W -D_REENTRANT $(DEFINES)
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -L/usr/local/lib -L/usr/lib -L/lib -lmtp -I/usr/include/taglib -L/usr/lib -ltag -lQtGui -lQtCore -lpthread
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
