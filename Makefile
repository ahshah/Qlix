...
# Generated by qmake (2.01a) (Qt 4.2.3) on: Wed Aug 22 23:45:31 2007
# Project:  Qlix.pro
# Template: app
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib/qt4 -L/usr/local/lib -L/usr/lib -L/lib -lmtp -I/usr/local/include/taglib -ltag -lQtGui -L/usr/lib/mysql -L/usr/lib/qt4 -lpng -lSM -lICE -lXi -lXrender -lXrandr -lXfixes -lXcursor -lXinerama -lfreetype -lfontconfig -lXext -lX11 -lQtCore -lz -lm -ldl -lpthread
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
